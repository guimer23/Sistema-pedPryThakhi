                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                <form id="frmregistrocliente"  enctype="multipart/form-data">
                                  <div class="row">
...
<html lang="es">
  <head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyARu7kkxeBLPH6O5E8PwEAcWrw2okeUXmA&callback=initMap"></script>
<style type="text/css">
