...
require_once("../../Controllers/admClsConexion.php");
	$c= new Conectar();
		$conexion=$c->conexion();
	$sql="SELECT CLIdni,CLInombre,CLIapellido,CLIcelular,CLIemail from admclitcliente ";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="#" id="ir3" class="btn btn-primary px-4 float-right mt-0 mb-3"><i class="mdi mdi-plus-circle-outline mr-2"></i>Agregar Nuevo Cliente</a>
                                    <h4 class="header-title mt-0">Detalles de Clientes</h4>
                                    <div class="table-responsive dash-social">
                                        <table id="TablaCliente" class="table">
