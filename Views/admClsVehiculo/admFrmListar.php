...
require_once("../../Controllers/admClsConexion.php");
	$c= new Conectar();
		$conexion=$c->
conexion(); $sql="SELECT VEHid,VEHplaca,VEHmarca,VEHmodelo,VEHcolor,VEHanio_fabricacion,VEHestado from admvehtvehiculo
                ...
                <div class="main-icon-menu">
                    <nav class="nav">
                        ...
                        <a
                            ...
                            class="nav-link"
                            d
                            activeata-toggle="tooltip-custom"
                            data-placement="top"
                            title=""
                ...
                <div class="main-menu-inner">
                    <div class="menu-body slimscroll">
                        ...
                        <div id="Ordenes" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="../../Views/admClsMonitorear/admFrmListar.php">
                                        <i class="mdi mdi-google-maps"></i>
                                        Monitorear
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../../Views/admClsEntrega/admFrmListar.php">
                                        <i class="mdi mdi-package-variant"></i>
                                        Entregas
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../../Views/admClsCalificar/admFrmListar.php">
                        ...
                        <div id="Mantenimiento" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="../../Views/admClsVehiculo/admFrmListar.php">
                                        <i class="mdi mdi-car-multiple"></i>
                                        Vehículos
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../../Views/admClsConductor/admFrmListar.php">
                                        <i class="mdi mdi-google-street-view"></i>
                                        Conductores
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../../Views/admClsVehiculoConductor/admFrmListar.php">
                                        <i class="mdi mdi-train-car"></i>
                                        Vehículo - Conductor
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../../Views/admClsCliente/admFrmListar.php">
                                        <i class="mdi mdi-account-multiple"></i>
                                        Clientes
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../../Views/admClsUsuario/admFrmListar.php">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="#" id="irr" class="btn btn-primary px-4 float-right mt-0 mb-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="#"
                                                            class="mr-2"
                                                            onclick="TraeDatos('<?php echo  $ver[0]?>')"
                                                        >
                                                            <i class="fas fa-edit text-info font-16"></i>
                                                        </a>
                                                        <a href="#" onclick="llenar('<?php echo  $ver[0]?> ')">
                                                            <i
                                                                class="fas fa-eye text-dark font-16"
                                                                data-toggle="modal"
