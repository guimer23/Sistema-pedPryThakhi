        ...
        <div class="left-sidenav">
            <div class="main-icon-menu">
                <nav class="nav">
                    ...
                    <a href="#Ordenes" class="nav-link" d activeata-toggle="tooltip-custom" data-placement="top"
                        title="" data-original-title="Entregas">
            ...
            <div class="main-menu-inner">
                ...
                <div class="menu-body slimscroll">
                    ...
                    <div id="Ordenes" class="main-icon-menu-pane">
                        ...
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link"
                                    href="../../Views/admClsMonitorear/admFrmListar.php"><i
                                        class="mdi mdi-google-maps"></i>Monitorear</a></li>
                            <li class="nav-item"><a class="nav-link"
                                    href="../../Views/admClsEntrega/admFrmListar.php"><i
                                        class="mdi mdi-package-variant"></i>Entregas</a></li>
                            <li class="nav-item"><a class="nav-link"
                                    href="../../Views/admClsCalificar/admFrmListar.php"><i
                    ...
                    <div id="Mantenimiento" class="main-icon-menu-pane active">
                        ...
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link"
                                    href="../../Views/admClsVehiculo/admFrmListar.php"><i
                                        class="mdi mdi-car-multiple"></i>Vehículos</a></li>
                            <li class="nav-item"><a class="nav-link"
                                    href="../../Views/admClsConductor/admFrmListar.php"><i
                                        class="mdi mdi-google-street-view"></i>Conductores</a></li>
                            <li class="nav-item"><a class="nav-link"
                                    href="../../Views/admClsVehiculoConductor/admFrmListar.php"><i
                                        class="mdi mdi-train-car"></i>Vehículo - Conductor</a></li>
                            <li class="nav-item"><a class="nav-link"
                                    href="../../Views/admClsCliente/admFrmListar.php"><i
                                        class="mdi mdi-account-multiple"></i>Clientes</a></li>
                            <li class="nav-item"><a class="nav-link"
                                    href="../../Views/admClsUsuario/admFrmListar.php"><i
            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Vehículo - Conductor</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Vehículo - Conductor</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="#" id="ir2" class="btn btn-primary px-4 float-right mt-0 mb-3"><i
                                    ...
                                    <table id="TablaVehiculoConductor" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" onclick="ir('<?php echo $ver[0]; ?>')" class="mr-2"><i
