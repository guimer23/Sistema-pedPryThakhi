                    ...
                    <!--Inicia SubMenu Dashboard -->
                      ...
                      <div id="Mantenimiento" class="main-icon-menu-pane active">
                          ...
                          <ul class="nav">
                              ...
                              <li class="nav-item"><a class="nav-link active" href="pedFrmListar.php"><i class="mdi mdi-account-multiple"></i>Clientes</a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="pedFrmAgregar.php" class="btn btn-primary px-4 float-right mt-0 mb-3"><i class="mdi mdi-plus-circle-outline mr-2"></i>Agregar Nuevo Cliente</a>
