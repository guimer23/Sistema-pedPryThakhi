              ...
              <div class="main-icon-menu">
                  <nav class="nav">
                    <!--Inicia Menu Dashboard -->
                      ...
                      <a href="#Ordenes" class="nav-link active" d activeata-toggle="tooltip-custom" data-placement="top" title="" data-original-title="Entregas">
                                              ...
                                              <div class="row clearfix">
                                                ...
                                                <div class="row clearfix">
                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                              <label>Precio</label>
                                                              <input type="text" id="precio" name="precio" class="form-control" onkeypress="return filterFloat(event,this);" required >
                                                          </div>
                                                      </div>
                                                      <div class="col-md-6">
                                                          <label>Estado</label>
